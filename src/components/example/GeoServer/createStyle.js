...
/**
 * GeoServer rest 在工作区内创建新的点样式
 */
export function createGeoPointStyle(Options) {
    let options = Options || {};
...
/**
 * GeoServer rest 在工作区内创建新的线样式
 */
export function createGeoLineStyle(Options) {
    let options = Options || {};
    let styleName = options.styleName || '';
    let legendName = options.legendName || '';
...
/**
 * GeoServer rest 在工作区内创建新的面样式
 */
export function createGeoPolygonStyle(Options) {
    let options = Options || {};
    let styleName = options.styleName || '';
    let legendName = options.legendName || '';
    let lineType = options.lineType || '';
